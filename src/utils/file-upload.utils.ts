...
const DEFAULT_MAX_FILE_SIZE_IN_BYTES = 1024000000; // 1GB
...
function buildFileTypeRegex(requiredTypes: string[]) {
  ...
  console.log(formattedRequiredTypes);
 ...
 * @param {array} requiredTypes array of allowed file types for upload, if empty array is passed file type check will be bypassed
